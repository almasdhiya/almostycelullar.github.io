          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?php echo base_url('registrasi/index') ?>">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Your Username " name="username">
              ...
              <div class="text-center">
                <a class="small" href="<?php echo base_url('auth/login') ?>">Have an Account? Log in!</a>
              </div>
            </div>
          </div>
        </div>
